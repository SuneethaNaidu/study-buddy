...
```bash
git clone https://github.com/suneethanaidu/Study-Buddy-App.git
cd Study-Buddy-App
```
...
📚 **Learn** concepts through AI-powered Q&A
↓
📝 **Summarize** lengthy study material
↓
🃏 **Revise** using generated flashcards
↓
